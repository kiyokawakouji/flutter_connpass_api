...
// ignore: unused_element
  _MainViewModelData call(
      {ConnpassResponse response, MainViewModelState viewModelState}) {
...
abstract class $MainViewModelDataCopyWith<$Res> {
  ...
  $Res call({ConnpassResponse response, MainViewModelState viewModelState});

  $ConnpassResponseCopyWith<$Res> get response;
}
...
class _$MainViewModelDataCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      response:
          response == freezed ? _value.response : response as ConnpassResponse,
  ...
  $ConnpassResponseCopyWith<$Res> get response {
    ...
    return $ConnpassResponseCopyWith<$Res>(_value.response, (value) {
...
class _$_MainViewModelData implements _MainViewModelData {
  ...
  @override
  final ConnpassResponse response;
  @override
